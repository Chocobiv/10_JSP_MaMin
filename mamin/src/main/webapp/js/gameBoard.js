...
let nation_infobox = [ { n_comment : '부자가 되어 돌아오세요!' , n_img : '' },
					   ...
					   { n_comment : '스핑크스가 지키는 거대한 피라미드가 있는 인류 문명의 보고\n카이로에 어서 오세요!' , n_img : '/mamin/img/game/nation/카이로.jpg'},
					   { n_comment : '강인한 바이킹과 햄릿, 인어공주의 도시, 코펜하겐에 어서 오세요!' , n_img : '/mamin/img/game/nation/코펜하겐.jpg' },
					   { n_comment : '유럽과 아시아의 경계\n역사 속의 명소가 살아 숨 쉬는 이스탄불에 어서 오세요!' , n_img : '/mamin/img/game/nation/이스탄불.jpg' },
					   ...
					   { n_comment : '첨단 도시와 아름다운 조경\n웅장한 자연이 공존하는 싱가폴에 어서 오세요!' , n_img : '/mamin/img/game/nation/싱가폴.jpg' },
					   { n_comment : '인류 문명과 지성의 출발지. 신들의 도시 아테네에 어서 오세요!' , n_img : '/mamin/img/game/nation/아테네.jpg' },
					   { n_comment : '어떤 행운이 기다리고 있을까요?' , n_img : '' },
					   { n_comment : '알프스와 요들의 나라\n상대성 이론의 고향 스위스 베른에 어서 오세요!' , n_img : '/mamin/img/game/nation/베른.JPG' },
					   { n_comment : 'Ola! 트램을 타고 빨간 지붕 아래를 거닐면 평화나 행복이라는 말과 제법 가까워질 거예요. 리스본에 어서 오세요!' , n_img : '/mamin/img/game/nation/리스본.webp' },
					   { n_comment : '문화와 예술, 축구와 스페인 왕정이 머무는 에스파냐의 중심.\n마드리드에 어서 오세요!' , n_img : '/mamin/img/game/nation/마드리드.webp' }, 
					   { n_comment : '4년마다 열리는 세계인의 축제가, 마블의 민족에선 하루에도 몇 번이고 만나볼 수 있죠!' , n_img : '' },
					   { n_comment : '오로라와 눈, 나이아가라 폭포의 나라\n케나다의 수도 오타와에 어서 오세요!' , n_img : '/mamin/img/game/nation/오타와.JPG' },
					   { n_comment : '캥거루와 광활한 대지, 다양한 문화와 아름다운 해변이 공존하는\n호주에 어서 오세요!' , n_img : '/mamin/img/game/nation/시드니2.png' },
					   { n_comment : '휴양으로 유명한 섬은 많지만\n천국이라고 비유되는 곳은 이곳밖에 없죠. 하와이에 어서 오세요!' , n_img : '/mamin/img/game/nation/하와이1.jpg' },
					   { n_comment : '어떤 행운이 기다리고 있을까요?' , n_img : '' },
					   { n_comment : '장벽이 있던 아픔과 강을 따라 일어난 기적부터\n그 위에 피어난 문화가 겹겹이 쌓여있는\n어쩌면 우리와 아주 닮아있는 베를린에 어서 오세요!' , n_img : '/mamin/img/game/nation/베를린.webp' },
					   ...
					   { n_comment : '제국의 수도였으면서 가톨릭의 성지 바티칸을 품고 있는\n유럽 역사의 보고, 로마에 어서 오세요!' , n_img : '/mamin/img/game/nation/로마.JPG' },
					   ...
					   { n_comment : '어떤 행운이 기다리고 있을까요?' , n_img : '' },
					   { n_comment : '해운대의 부서지는 파도부터 광안리의 찰박이는 물살까지\n강약강약단짠단짠의 도시. 붓싼에 어서 오세요!' , n_img : '/mamin/img/game/nation/부산.JPG' },
