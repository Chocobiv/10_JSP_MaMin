...
=======
	<button style="display: none;" type="button" class="modalinfoBtn btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"></button>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content modalbox">
				<div class="modal-header ingame_userInfo">
					<h1 class="modal-title fs-5" id="exampleModalLabel">Information</h1>
					<button type="button" class="btn-close m_btn_close"
						data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal_contentsbody"></div>
			</div>
		</div>
>>>>>>> refs/remotes/origin/chocobiv
	</div>
